class GenerateOverviewJob < ApplicationJob
  ...
  def build_prompt(grouped_by_channel, user_names)
    ...
    lines << "- Use **bold** to highlight key names, topics, or notable events"
    lines << ""
    ...
    lines << "- Use valid markdown: `- ` (dash + space) for bullets, blank line before each list and after each bold header"
